...
import { FSR_SCHEMA } from "./FSR";
import { HSC_SCHEMA } from "./HSC";
import { HSS_SCHEMA } from "./HSS";
import { TPC_SCHEMA } from "./TPC";
import { TRD_SCHEMA } from "./TRD";
import { TSA_SCHEMA } from "./TSA";
...
const ALL_SCHEMAS = [
  ...
  FSR_SCHEMA, HSC_SCHEMA, HSS_SCHEMA, TPC_SCHEMA, TRD_SCHEMA, TSA_SCHEMA
];
